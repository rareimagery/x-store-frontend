...
const storeLinks: Array<{ href: Route; label: string; icon: string }> = [
  ...
  { href: "/console/favorite-creators" as Route, label: "Creator Collections", icon: "M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z" },
  ...
  { href: "/console/x-spaces" as Route, label: "X Spaces", icon: "M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 01-3-3V4.5a3 3 0 116 0v8.25a3 3 0 01-3 3z" },
];
...
const adminLinks: Array<{ href: Route; label: string; icon: string }> = [
  ...
  { href: "/console/admin/invites" as Route, label: "Invite Codes", icon: "M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 010 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 010-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375z" },
];
        ...
        {hasStore ? (
          <>
            <SidebarLink
              ...
              label="How To"
              isActive={isActive("/console" as Route)}
              onNavigate={onNavigate}
            />

            <p className="mt-3 mb-2 px-2 text-[10px] font-semibold uppercase tracking-wider text-zinc-500">
              Workspace
            </p>
            {storeLinks.map((link) => (

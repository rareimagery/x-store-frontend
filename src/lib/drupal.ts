  ...
  const variations: ProductVariation[] = variationRefs
    .map((ref: any) => {
      ...
      return {
        ...
        image_url: varImage,
        front_image_url: drupalAbsoluteUrl(va.field_variant_front_url) ?? va.field_variant_front_url ?? null,
        back_image_url: drupalAbsoluteUrl(va.field_variant_back_url) ?? va.field_variant_back_url ?? null,
